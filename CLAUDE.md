...
**핵심**: 3개 병렬 대기 중. 승인·결과 나오는 대로 대응.

0. **시작 시 상태 sanity check** (30초)
   - Apple ID 이메일 (`nanabox79@gmail.com`) 확인:
     - App Store Connect 심사 결과 알림 (승인/반려)
     - Play Console upload key reset 승인 알림 (NO.1·NO.2 별개)
   - App Store Connect → 나나박스 워터소트 앱 상태: "심사 대기 중" → "심사 중" → "판매 준비 완료" or "메타데이터 거부됨"
   - Play Console NO.1 v1.0 심사 상태
   - Unity 콘솔 에러 0 확인 (Firebase Editor 경고는 정상)

1. **🔴 iOS 심사 결과 대응**
   - **승인 시**: 자동 배포 활성화면 App Store 즉시 게시. 지인 실기 다운로드 검증. 첫 실행 ATT 팝업 (`NSUserTrackingUsageDescription`) 확인.
   - **반려 시**: 이메일 사유 확인. 대개 스크린샷 규격/처리방침 URL 접근/광고 문구 오해/ATT 문구. Resolution Center 답변 → 필요 시 수정 재제출.

2. **🔴 Play upload key reset 승인 대응** (NO.1·NO.2 별개)
   - 승인 나면 v1.1 AAB 재업로드 → 지문 통과할 것
   - 승인 안 나기 전엔 v1.1 업로드 불가 (계속 지문 불일치 에러)

3. **NO.1 Play v1.0 심사 결과 확인 → NO.2 도 심사 요청**
   - NO.1 07-18 재업로드 후 심사 중 (07-22 기준 4~5일차)
   - NO.1 승인 → Play Console NO.2 도 "검토를 위해 저장" 클릭
...
5. **App Store Connect 스토어 아이콘 (1024×1024)** — 심사 승인 후 재업로드 필요 시.

6. **정식 App Store 심사 승인 후 후속**
...
### 대기 중 (시간 지나면 자동 해결)
- iOS 심사 (24~48h)
- Play upload key reset NO.1·NO.2 (2~5 영업일)
- NO.1 Play v1.0 심사 (07-18 재업로드 후 4~5일차)
